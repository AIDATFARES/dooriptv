    ...
    <section className="py-20 bg-[#0c0f0f] text-white relative z-10 border-t border-white/10 overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <Link href={`/blog/${post.slug}`} key={post.id}>
              <article className="bg-[#121414] rounded-2xl overflow-hidden flex flex-col group cursor-pointer hover:-translate-y-2 transition-all duration-300 h-full border border-white/10 hover:border-[#d32f2f]/50 shadow-xl">
                <div className="h-48 relative overflow-hidden shrink-0">
                  ...
                  />
                  <div className="absolute bottom-0 w-full h-1/2 bg-gradient-to-t from-[#121414] to-transparent"></div>
                ...
                <div className="p-6 flex flex-col flex-grow">
                  <h3 className="text-lg font-bold leading-snug text-white group-hover:text-[#d32f2f] transition-colors mb-3 line-clamp-2">
                    {post.title}
                  </h3>
                  ...
                  <div className="mt-auto text-stone-500 text-xs font-medium flex items-center justify-between border-t border-white/10 pt-4">
                    <span>{post.date}</span>
                    <span className="flex items-center text-[#d32f2f] group-hover:translate-x-1 transition-transform font-bold text-sm">
                      Read More
        ...
        <div className="text-center">
          <Link href="/blog">
            <button className="bg-white/5 hover:bg-[#d32f2f] text-white border border-white/15 hover:border-[#d32f2f] px-8 py-3.5 rounded-full font-bold text-sm transition-all duration-300 flex items-center justify-center mx-auto gap-2 shadow-lg">
              View All Articles
